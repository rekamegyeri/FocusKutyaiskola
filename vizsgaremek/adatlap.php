    ...
    <section class="user-profile">
        <div class="container">
            ...
            <div class="profile-info">
                ...
                <div class="info-item regijelszo">
                    <label for="regijelszo">Régi jelszó:</label>
                    <input type="password" id="regijelszo" name="oldpwd" >
                </div>
                
                <div class="info-item ujjelszo">
                    <label for="ujjelszo">Új jelszó:</label>
                    <input type="password" id="ujjelszo" name="newpwd" >
                </div>
            ...
            <div class="button-container">
                ...
                <?php
                    ...
                    if(isset($userek['u_comment']) && trim($userek['u_comment']) === 'admin'){
                        echo"<a href='?p=admin'><button type='button' class='admin-button'>Admin felület</button><a/>";
                    }
