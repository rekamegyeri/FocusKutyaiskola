                    ...
                    if(isset($_SESSION['u_id'])) {
                         ...
                         if (isset($_SESSION['u_profkep_nev'])) {
                              print "  <a href='?p=adatlapom' title='Adatlap'><img src='./profkepek/".$_SESSION['u_profkep_nev']."' class='profilkep'></a>
                                        <a href='?p=kilepes' class='kilep-btn' title='Kilépés'><i class='bx bx-log-out-circle bx-flip-horizontal' id='kilep-btn'></i></a>
                              ";
                         }
                         else{
                              print "   <a href='?p=adatlapom' title='Adatlap'><i class='bx bxs-user-check' style='font-size: 2.5rem;' id='me-btn'></i></a>
                                        <a href='?p=kilepes' class='kilep-btn' title='Kilépés'><i class='bx bx-log-out-circle bx-flip-horizontal' id='kilep-btn'></i></i></a>
                              ";
                         }
                    }
                    else{
