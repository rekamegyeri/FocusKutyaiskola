...
const kurzusData = {
    ...
    "kolyok-kurzus": {
        indulas: [
            { value: "kolyok-kezdo", label: "Kezdő (2025.07.07. 10:00)" },
            { value: "kolyok-halado", label: "Haladó (2025.07.14. 8:00)" }
        ],
    ...
    "felnott-kurzus": {
        indulas: [
            { value: "felnott-kezdo", label: "Kezdő (2025.07.28. 10:00)" },
            { value: "felnott-halado", label: "Haladó (2025.07.21. 8:00)" }
        ],
    ...
    "idos-kurzus": {
        indulas: [
            { value: "idos-kezdo", label: "Kezdő (2025.08.04. 10:00)" },
            { value: "idos-halado", label: "Haladó (2025.08.11. 8:00)" }
        ],
        oktato: "Nagy Ákos"
    },
    ...
    "agility-kurzus": {
        indulas: [
            { value: "agility", label: "Agility (2025.08.18. 12:00)" }
        ],
        oktato: "Tóth Kata"
    },
	...
	"orzo-vedo-kurzus": {
        indulas: [
            { value: "orzo-vedo", label: "Őrző-védő (2025.08.04. 17:00)" }
        ],
        oktato: "Kovács Tünde"
    },
