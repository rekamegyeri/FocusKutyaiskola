<?php
     ...
     $dogs = mysqli_query($adb, "SELECT * FROM dog"); 
...
<head>
     ...
     <link href='https://unpkg.com/boxicons@2.1.4/css/boxicons.min.css' rel='stylesheet'>
      <link rel="stylesheet" href="styles.css"> <title>Focus Kutyaiskola - Admin</title>
</head>
                              ...
                              <?php
                                   ...
                                   if ($dogs->num_rows > 0) {
                                        while ($row = $dogs->fetch_assoc()) {
                                             echo "<tr>
                                                       <td>".(!empty($row['d_id']) ? $row['d_id'] : '-')."</td>
                                                       <td>".(!empty($row['d_nev']) ? $row['d_nev'] : '-')."</td>
                                                       <td>".(!empty($row['d_u_id']) ? $row['d_u_id'] : '-')."</td>
