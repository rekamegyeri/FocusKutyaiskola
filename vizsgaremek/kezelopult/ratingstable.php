<?php
     ...
     $ratings = mysqli_query($adb, "SELECT * FROM ertekeles"); 
                         ...
                         <?php
                                   if ($ratings->num_rows > 0) {
                                        while ($row = $ratings->fetch_assoc()) {
                                             echo "<tr>
                                                       <td>".(!empty($row['e_id']) ? $row['e_id'] : '-')."</td>
                                                       <td>".(!empty($row['e_u_id']) ? $row['e_u_id'] : '-')."</td>
                                                       <td>".(!empty($row['e_szoveg']) ? $row['e_szoveg'] : '-')."</td>
                                                       <td>".(!empty($row['e_szam']) ? $row['e_szam'] : '-')."</td>
                                                       <td>".(!empty($row['e_datum']) ? $row['e_datum'] : '-')."</td>
